                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-3">
                                <label for="userLogin" class="col-md-4 col-form-label text-md-end">Email/Phone</label>

                                <div class="col-md-6">
                                    <input id="userLogin" type="text"
                                        class="form-control @error('userLogin') is-invalid @enderror" name="userLogin"
                                        value="{{ old('userLogin') }}" required autocomplete="userLogin" autofocus>
